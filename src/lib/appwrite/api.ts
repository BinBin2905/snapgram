...
export async function createPost(post: INewPost) {
  try {
    ...
    console.log(" in function createPost() - fileUrl: ", fileUrl);
...
export async function uploadFile(file: File) {
  try {
    ...
    console.log(" in function uploadedFile(): ", uploadedFile);
    return uploadedFile;
  } catch (error) {
    console.log(error);
  }
...
export function getFilePreview(fileId: string) {
  try {
    ...
    console.log(" in function getFilePreview(): ", fileUrl);
    return fileUrl;
  } catch (error) {
    console.log(error);
  }
...
export async function deleteSavePosts(savedRecordId: string) {
  try {
